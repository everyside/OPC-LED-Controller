...
public class OPC extends PApplet implements Runnable
{
  ...
  public void ledStrip(int index, int count, double x, double y, double spacing, double angle, boolean reversed)
  {
               ...
               float ledSpacing, float stripSpacing, float angle, boolean zigzag)
  {
    ...
    for (int i = 0; i < numStrips; i++) {
      ledStrip(index + stripLength * i, stripLength,
        ...
        (float)(y + (i - (numStrips-1)/2.0) * stripSpacing * s), ledSpacing,
        angle, zigzag && (i % 2) == 1);
    }
  }
